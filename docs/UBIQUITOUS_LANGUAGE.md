...
| **Dev server** | A long-running process serving the repo's app for development and testing. Owned and run by the **orchestrator**; workers request one over their report line and never start their own. | "local server", "the app" |
